...
class Conf:
    ...
    cassette = 'cassette-DialogFrameTutorial'
    # メインテキストの名前
    maintextName = 'DialogFrameTutorial.txt'
    ...
    # タイトル
    dialogTitle = 'DialogFrameTutorial'
    ...
    useOpening = True
    # オープニング背景
    openingBackGroundImage = 'skype.jpg'
    # オープニングBGM
    openingBGM = {
        'name': 'machi.mp3',
        'volume': 0.3,
    ...
    linkingList = [
        {'【せんせー】': {'main':'lecturer.png', 'back':'lecturer_back.png'}},
        {'【こども】': {'main':'pupil.png', 'back':'pupil_back.png'}},
    ]
